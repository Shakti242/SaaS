...
function postContentToWebHook(arg0: string, url: string) {
    throw new Error('Function not implemented.')
}
function postMessageToSlack(arg0: string, channels: { label: string; value: string }[], arg2: string) {
    throw new Error('Function not implemented.')
}

function onCreateNewPageInDatabase(arg0: string, arg1: string, arg2: any) {
    throw new Error('Function not implemented.')
}
